...
onMounted(() => {
  nextTick(() => {
    ...
    // const textTure = loader.load('../../public/texture/door/color.jpg')
    const material = new THREE.MeshStandardMaterial({
      // color: 0xff000,
      // map: textTure,
      // aoMap: loader.load('../../public/texture/door/ao.jpg'),
      // roughnessMap: loader.load('../../public/texture/door/roughness.jpg'),
      // displacementMap: loader.load('../../public/texture/door/displacement.jpg'),
      // normalMap: loader.load('../../public/texture/door/normal.jpg'),
    });
    // 环境光
